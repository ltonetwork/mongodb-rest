                    ...
                    collection.find(query, options, function(err, cursor) {
                        ...
                        cursor.toArray(function(err, docs){
                            ...
                            if(req.params.id) {
                                ...
                                console.log('after:');
                                console.log(result);
                                res[collectionResponseType](result);
                            }
